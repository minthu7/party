			...
			<table>
				...
				<jstlcore:choose>
					  <jstlcore:when test="${event[6] != 0}">
							...
							<jstlcore:out value="${event[7]}"></jstlcore:out>
						...
						<jstlcore:if test="${visitor.admin == true}">	
							<td align="center">
								<a href="<jstlcore:url value="/displayEvent.htm?eventId=${event[0]}&sessionId=${event[6]}"/>"> Update </a>								
							</td>						
							<td align="center">
								<a href="<jstlcore:url value="/deleteEvent.htm?eventId=${event[0]}&sessionId=${event[6]}"/>"> Delete </a>								
							</td>	
						</jstlcore:if>						
					</tr>
				</jstlcore:forEach>
