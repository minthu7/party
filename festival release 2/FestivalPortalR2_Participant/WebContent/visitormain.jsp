													...
													<jstlcore:forEach items="${regEvents}" var="regEvent">
														<tr align="center">
															...
															<td width="100px" bgcolor="#CCCC99"><a
																href="<jstlcore:url value="/eventunreg.htm?eventId=${regEvent[0]}&eventsessionid=${regEvent[6]}"/>">Release</a>
															</td>
														</tr>
													</jstlcore:forEach>
													<tr>
						...
						<table class="content" width="96%" border="1" align="center">
							...
							<jstlcore:forEach items="${allEvents}" var="event">
								<tr>
									...
									<td align="center"><jstlcore:out value="${event[6]}"></jstlcore:out></td>
									<jstlcore:choose>
										<jstlcore:when test="${event[6] != 0}">
											<td width="100px" bgcolor="#CCCC99" align="center"><jstlcore:out
													value="${event[7]}"></jstlcore:out> <strong> seats
													left.</strong> <a
												href="<jstlcore:url value="/eventreg.htm?eventId=${event[0]}&sessionId=${event[6]}"/>">Register</a>
											</td>
										</jstlcore:when>
										<jstlcore:otherwise>
